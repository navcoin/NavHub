...
{{< project_links
    title="Get NavPay"
    subtitle="NavPay is supported as a web wallet and progressive web application. The platform specific builds are being deprecated."
    fontColor="#FFF"
    bgColor="#7d5ab5"
    linkBgColor="#523971"
    gradient=""
    feature1Img="/images/icons/icon-globe.png"
    feature1Title="Web Wallet (v5.0.1)"
    ...
    feature4Title="Windows (v5.0.1)"
    feature4Url="https://navpay.navcoin.org"
    feature5Img="/images/icons/icon-linux.png"
    feature5Title="Linux (v5.0.1)"
    feature5Url="https://navpay.navcoin.org"
    feature6Img="/images/icons/icon-apple.png"
    feature6Title="OSX (v5.0.1)"
    feature6Url="https://navpay.navcoin.org">}}
